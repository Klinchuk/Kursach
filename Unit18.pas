...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.Menus, Vcl.ExtCtrls, Vcl.MPlayer,
...
0: AssignFile( f ,'Обо всем/1.txt');
1: AssignFile( f ,'Обо всем/2.txt');
2: AssignFile( f ,'Обо всем/3.txt');
end;
