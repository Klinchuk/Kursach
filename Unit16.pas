...
uses
  ...
  Vcl.Imaging.jpeg, Vcl.MPlayer, Vcl.StdCtrls;
...
0: AssignFile( f ,'ИПО/ИПО1.txt');//связывается с разными файлами
1: AssignFile( f ,'ИПО/ИПО2.txt');
2: AssignFile( f ,'ИПО/ИПО3.txt');
end;
