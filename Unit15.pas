...
uses
  ...
  Vcl.Imaging.jpeg, Vcl.ExtCtrls, Vcl.MPlayer;
...
0: AssignFile( f ,'ТРПО/ТРПО1.txt');//связывается с разными файлами
1: AssignFile( f ,'ТРПО/ТРПО2.txt');
2: AssignFile( f ,'ТРПО/ТРПО3.txt');
end;
